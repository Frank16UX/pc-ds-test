...
const SectionPaddingComponent = () => {
  return (
    <div style={{ padding: '24px', maxWidth: '1200px' }}>
      <h1 style={{ marginBottom: '16px', fontSize: '32px', fontWeight: '700' }}>Section Padding · Desktop</h1>
      <p style={{ marginBottom: '32px', color: '#666', maxWidth: '800px' }}>
        Section padding tokens for desktop viewports. These define consistent spacing between major layout sections.
      </p>
...
const meta = {
  title: 'Foundations/Responsive/Desktop/Section Padding',
  component: SectionPaddingComponent,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Section padding tokens for desktop viewports to maintain consistent spacing in layouts.',
      },
    },
  },
  tags: ['autodocs'],
