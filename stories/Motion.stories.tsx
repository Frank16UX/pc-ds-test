...
const motionTokens = {
  durations: {
    productive: [
      { name: 'Productive XS', scssVar: '$durations-productive-xs' },
      { name: 'Productive SM', scssVar: '$durations-productive-sm' },
      { name: 'Productive MD', scssVar: '$durations-productive-md' },
      { name: 'Productive LG', scssVar: '$durations-productive-lg' },
      { name: 'Productive XL', scssVar: '$durations-productive-xl' },
      { name: 'Productive XXL', scssVar: '$durations-productive-xxl' },
    ],
    expressive: [
      { name: 'Expressive XS', scssVar: '$durations-expressive-xs' },
      { name: 'Expressive SM', scssVar: '$durations-expressive-sm' },
      { name: 'Expressive MD', scssVar: '$durations-expressive-md' },
      { name: 'Expressive LG', scssVar: '$durations-expressive-lg' },
      { name: 'Expressive XL', scssVar: '$durations-expressive-xl' },
      { name: 'Expressive XXL', scssVar: '$durations-expressive-xxl' },
    ],
  },
  easings: [
    { name: 'Direct', scssVar: '$easings-direct-direct-curve', description: 'Fast, immediate transitions' },
    { name: 'Enter', scssVar: '$easings-indirect-enter-curve', description: 'Elements entering the view' },
    { name: 'Exit', scssVar: '$easings-indirect-exit-curve', description: 'Elements leaving the view' },
    { name: 'Standard', scssVar: '$easings-indirect-standard-curve', description: 'Standard transitions' },
    { name: 'Linear', scssVar: '$easings-indirect-linear-curve', description: 'Constant speed' },
  ],
  delays: {
    productive: [
      { name: 'Productive XS', scssVar: '$delays-productive-xs' },
      { name: 'Productive SM', scssVar: '$delays-productive-sm' },
      { name: 'Productive MD', scssVar: '$delays-productive-md' },
      { name: 'Productive LG', scssVar: '$delays-productive-lg' },
      { name: 'Productive XL', scssVar: '$delays-productive-xl' },
      { name: 'Productive XXL', scssVar: '$delays-productive-xxl' },
    ],
    expressive: [
      { name: 'Expressive XS', scssVar: '$delays-expressive-xs' },
      { name: 'Expressive SM', scssVar: '$delays-expressive-sm' },
      { name: 'Expressive MD', scssVar: '$delays-expressive-md' },
      { name: 'Expressive LG', scssVar: '$delays-expressive-lg' },
      { name: 'Expressive XL', scssVar: '$delays-expressive-xl' },
      { name: 'Expressive XXL', scssVar: '$delays-expressive-xxl' },
    ],
  },
};
